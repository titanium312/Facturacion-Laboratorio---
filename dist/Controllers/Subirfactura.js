...
exports.enviarAdmisionesFacturas = void 0;
const axios_1 = __importDefault(require("axios"));
const https_1 = __importDefault(require("https"));
const token_1 = require("./ids/token"); // 🔹 Importamos el array de tokens
/**
...
const enviarAdmisionesFacturas = async (req, res) => {
    try {
        ...
        const tokenObj = token_1.token.find(t => t.FacturadorId === FacturadorId);
        if (!tokenObj) {
        ...
        const payload = {
            ...
            FacturasCompletasPasar: {
                ...
                FacturasProcedimientosF: procedimientos?.map((p) => ({
        ...
        const response = await axios_1.default.post("https://balance.saludplus.co/admisiones/AdmisionesFacturasEditar", payload, {
            headers: {
...
exports.enviarAdmisionesFacturas = enviarAdmisionesFacturas;
